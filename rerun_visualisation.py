...
# folder2 = 'save_latest/my_humanml_trans_dec_bert_512_hdepic_v4_CA/samples_my_humanml_trans_dec_bert_512_hdepic_v4_CA_000550000_seed10/results.npy'
# folder2 = 'save_latest/my_humanml_trans_dec_bert_512_hdepic_v4_CA_lossawaresampler/samples_my_humanml_trans_dec_bert_512_hdepic_v4_CA_lossawaresampler_000550000_seed10/results.npy'
folder2 = 'save_latest/my_humanml_trans_dec_bert_512_hot3d/samples_my_humanml_trans_dec_bert_512_hot3d_000622000_seed10/results.npy' 
predictions = np.load(folder2, allow_pickle=True)[None][0]
name_list = predictions['names']
preds = predictions['motion'].transpose(0, 3, 1, 2)[:370]
motion = preds[:,-1] - preds[:,0]
motion = np.linalg.norm(motion, axis=-1)[:,0]
index = np.argsort(motion)[-10]
# pdb.set_trace()
...
create_gt_vs_pred_joints_visualization(
    save_path=f"hot3d_train_{index}.rrd",
    data_dir=DATA_DIR,
