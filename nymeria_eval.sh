...
conda activate mdm
# python -m eval.eval_humanml --model_path save_latest/my_humanml_trans_dec_bert_512_nymeria_final_V2/model000800000.pt --wandb_name Nymeria_eval_v2 --eval_mode debug
python -m eval.eval_humanml --model_path ./models_to_upload/humanml_trans_dec_512_bert/model000600000.pt --wandb_name Nymeria_eval_v2 --eval_mode debug
